...
export function rejectEmptyInput(req: Request, res: Response): boolean {
    if (req.method !== "GET") {
...
export async function checkAfiliadosRetirados(req: Request, res: Response, cedula: number | string) {
    try {
...
export function deleteOldBackups(backupName: string) {
