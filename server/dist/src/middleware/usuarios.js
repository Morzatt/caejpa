...
function editUser(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const usuario = yield (0, usuarios_1.usuarios)().getUser(id);
            yield (0, usuarios_1.usuarios)().editUser(id, (nombre ? nombre : usuario[0].nombre), (apellido ? apellido : usuario[0].apellido), (username ? username : usuario[0].username), (role ? role : usuario[0].role));
            res.status(200).send({
